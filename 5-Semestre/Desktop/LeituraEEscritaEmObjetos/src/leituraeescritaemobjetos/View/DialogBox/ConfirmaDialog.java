 ...
 */
package leituraeescritaemobjetos.View.DialogBox;
...
public class ConfirmaDialog {
    // Confirmar Exclusão
    public static boolean msgConfimarExclusao(String msg){
            String message = "Deseja realmente excluir a entrada: "+ msg + " ?";
