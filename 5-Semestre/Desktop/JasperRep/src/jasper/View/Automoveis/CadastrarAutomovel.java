...
public class CadastrarAutomovel extends javax.swing.JFrame {
    ...
    public  void carregarCombobox(){
        try {
            ResultSet result = fab.returnAll();
            while(result.next()){
    ...
    public CadastrarAutomovel(AutomovelController ac) {
        initComponents();
        this.setTitle("Alterar Automovel: " + ac.getAutomovel().getModelo());
        jLabelTitulo.setText("Alterar Automovel: " + ac.getAutomovel().getModelo());
        isNew = false;
        this.ident = ident;
        fab = new FabricanteController();
        this.ac = ac;
        ...
        carregarCombobox();
        jComboBoxFabricante.setModel(aModel);
        jTextFieldModelo.setText(ac.getAutomovel().getModelo());
        jTextFieldGasolinaEfici.setText(String.valueOf( ac.getAutomovel().getGasolina_efici()));
        jTextFieldAlcoolEfici.setText(String.valueOf( ac.getAutomovel().getAlcool_efici()));
        jTextFieldDieselEfici.setText(String.valueOf( ac.getAutomovel().getDiesel_efici()));
        ListItem l = new ListItem(
                ac.getAutomovel().getFabricante().getId(), 
                ac.getAutomovel().getFabricante().getNome()
        );
        aModel.setSelectedItem(l);
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jComboBoxFabricante, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ListItem combobox = (ListItem) jComboBoxFabricante.getSelectedItem();
        ac.getAutomovel().setModelo(jTextFieldModelo.getText());
        ac.getAutomovel().getFabricante().setId(combobox.getId());
        ac.getAutomovel().getFabricante().setNome(combobox.getValue());
        ac.getAutomovel().setGasolina_efici(Float.parseFloat(jTextFieldGasolinaEfici.getText()));
        ac.getAutomovel().setAlcool_efici(Float.parseFloat(jTextFieldAlcoolEfici.getText()));
        ac.getAutomovel().setDiesel_efici(Float.parseFloat(jTextFieldDieselEfici.getText()));
        if(isNew){
            ac.insert();
        }else{
            ac.update();
